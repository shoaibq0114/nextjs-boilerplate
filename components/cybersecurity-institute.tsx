    ...
    <div className="min-h-screen">
      ...
      <section className="py-20">
        <div className="container mx-auto text-center">
          <h1 className="text-4xl md:text-6xl font-bold mb-6"><FlipWords words={["Secure", "Respond", "Mitigate", "Harden", "Lead"]} duration={1500}/> <br /></h1>
          <h2 className="text-2xl md:text-4xl mb-8">Turn Your Passion for Cybersecurity into a Professional Career</h2>
